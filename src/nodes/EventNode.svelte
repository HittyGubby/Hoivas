...
{#if selected}
  <NodeResizer minWidth={250} color="#ff0071" keepAspectRatio={false} />
{/if}
...
<div class="event-scaler" style:transform="scale({scale})" style:width="{BASE_WIDTH}px">
  <div class="event-window-container" style="height: {totalRefHeight}px;">
    <!-- Tiled Background -->
    <img src="/template/news/event_report_top_win.png" style="position: absolute; top: 2px; left: 0; width: 100%; z-index: 1;" alt="" />

    {#each tileArray as _, i}
      <img src="/template/news/event_report_tileable_midsection.png" style="position: absolute; top: {120 + i * TILE_HEIGHT}px; left: 0; width: 100%; height: {TILE_HEIGHT}px; z-index: 1;" alt="" />
    {/each}

    <img src="/template/news/event_report_bottom_win.png" style="position: absolute; top: {120 + tiles * TILE_HEIGHT}px; left: 0; width: 100%; z-index: 1;" alt="" />
    ...
    <button
      style="position: absolute; top: {150 +
        tiles *
          TILE_HEIGHT}px; left: 115px; width: 352px; height: 48px; border: none; background: url('/template/news/event_option_entry.png') no-repeat; background-size: 100% 100%; color: #FFFFFF; font-family: 'electrolize', 'FZRui', sans-serif; font-size: 18px; cursor: pointer; z-index: 4;"
    >
