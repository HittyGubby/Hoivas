...
{#if selected}
  <NodeResizer minWidth={200} color="#ff0071" keepAspectRatio={true} />
{/if}
...
<div class="main-scaler" style:transform="scale({scale})" style:width="{BASE_WIDTH}px">
  <div class="main-window-container">
    <!-- Flag Section -->
    <div class="flag-box">
      <img src={data.flagImg || "/preset/USA.png"} class="fill-img" alt="" />
      <img src="/template/flag_overlay.png" class="fill-img overlay-flag" alt="" />
    </div>

    <!-- Leader Section -->
    <div class="leader-box">
      <img src="/template/Leader_Background.png" class="fill-img" alt="" />
      <img src={data.leaderImg || "/preset/USA_donald_trump5.png"} class="fill-img" alt="" />
      <img src="/template/diplo_leader_frame.png" class="leader-frame" alt="" />
    </div>

    <!-- UI Background Frames -->
    <img src="/template/diplo_upper_win_bg.png" class="upper-bg" alt="" />
    <img src="/template/diplo_top_bg_diplo_tab.png" class="tab-bg" alt="" />
    ...
    <div class="pie-chart-container">
      <img src="/template/bck_shadow.png" class="pie-shadow" alt="" />
      <div class="pie-wrapper">
        <PieChart data={data.chartData} />
      </div>
      <img src="/template/pol_piechart_overlay_63x63.png" class="pie-overlay" alt="" />
    </div>
    ...
    <div class="focus-icon-container">
      <img src={data.focusImg || "/preset/goal_unknown.png"} style:transform="scale({data.focusScale || 0.9})" class="focus-img" alt="" />
    </div>
    <div class="focus-progress-container">
      <img src="/template/pol_goal_progress_frame.png" class="progress-frame" alt="" />
      <img src="/template/diplo_goal_button.png" class="goal-btn" alt="" />
      <div class="progress-bar-clip" style:width="{data.progress || 0}px">
        <img src="/template/pol_goal_progress.png" style:width="235px" style:height="10px" alt="" />
      </div>
    </div>
