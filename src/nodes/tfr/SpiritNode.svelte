...
<div class="spirit-scaler" style:transform="scale({scale})" style:width="{BASE_WIDTH}px">
  <div class="spirit-window-container">
    <img src="/tfr/template/diplo_nat_spirits_bg_top.png" style="position: absolute; top: 0; left: 0; width: 100%;" alt="" />

    <div
      style="position: absolute; top: {TOP_HEIGHT}px; left: 0; width: 100%; height: {contentHeight}px; background-image: url(/tfr/template/diplo_nat_spirits_bg_tileable.png); background-repeat: no-repeat; background-size: 100% 100%;"
    ></div>

    <img src="/tfr/template/diplo_nat_spirits_bg_bottom.png" style="position: absolute; top: {TOP_HEIGHT + contentHeight}px; left: 0; width: 100%;" alt="" />
