...
<div class="spirit-scaler" style:transform="scale({scale})" style:width="{BASE_WIDTH}px">
  <div class="spirit-window-container">
    <img src="/pb/template/diplo_nat_spirits_bg_top.png" style="position: absolute; top: 0; left: 0; width: 100%;" alt="" />

    <div
      style="position: absolute; top: {TOP_HEIGHT}px; left: 0; width: 100%; height: {contentHeight}px; background-image: url(/pb/template/diplo_nat_spirits_bg_tileable.png); background-repeat: vertical; background-size: 100% 100%;"
    ></div>

    <img src="/pb/template/diplo_nat_spirits_bg_bottom.png" style="position: absolute; top: {TOP_HEIGHT + contentHeight}px; left: 0; width: 100%;" alt="" />
    ...
    <!-- Title -->
    <div style="position: absolute; left: 15px; top: 10px; z-index: 5; color: #cccccc; text-shadow: 1px 1px 2px black; font-family: 'Ubuntu', sans-serif;font-weight:600; font-size: 16px;">国家精神</div>
  </div>
</div>
