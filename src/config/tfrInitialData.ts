...
export const TFR_INITIAL_FOCUS_NODES: Node[] = [
  {
    ...
    type: "focus",
    position: { x: 200, y: 50 },
    data: { icon: "/tfr/preset/USA_USA_enforce_order.png", label: "保持秩序", status: "completed" },
  },
  {
    id: "focus-init-2",
    type: "focus",
    position: { x: 100, y: 200 },
    data: { icon: "/tfr/preset/USA_USA_invoke_the_insurrection_act.png", label: "通过叛乱法", status: "inProgress" },
  },
  {
    id: "focus-init-3",
    type: "focus",
    position: { x: 300, y: 200 },
    data: { icon: "/tfr/preset/USA_USA_lasting_peace.png", label: "持久和平", status: "unavailable" },
  },
];
