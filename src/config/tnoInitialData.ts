...
export const TNO_INITIAL_NODES: Node[] = [
  ...
  },
  {
    ...
    data: {
      title: "德国内战",
      body: "在阿道夫·希特勒去世后，德国旋即陷入混乱。尽管元首指定了合法的继任者，但德国国内的强大派系已经开始拿起武器，互相对抗，打算将国家引导向自己的期望。国家已被分裂，整支整支的驻军无视来自日耳曼尼亚的命令，并倒向他们选择的继任者。虽然局势的严重程度尚不清楚，但据估计，德国要么正在面临要么已经经历了中央权威的彻底崩溃。<br><br>虽然还不大清楚德国东部领地的命运将会如何，但日耳曼尼亚与她的殖民领之间突然断绝了联系，这已经引发了这些地区是否也会自行寻找出路的猜测。然而，有一点毫无疑问，这个欧洲巨人的崩溃已经使整个欧陆陷入分崩离析之中。",
      buttonText: "帝国的终结。",
      newsImg: "/tno/preset/GER_german_civil_war.png",
      headerImg: "/tno/preset/nazist-Germany.png"
    },
    width: 500,
    height: 560
  },
  ...
  },
  {
    ...
    data: {
      title: "内战打响！",
      body: "多年以来，虽然国内各派系之间的紧张局势一直在加剧，但谁都没有想到，元首尸骨未寒，暴力冲突就爆发了。当然，人人都能看见，政客们躲回了自己的老巢，军队分发了装备并封锁了道路，警察则拿起了他们手头上最强大的武器，用路障封锁了他们的警察局，但谁能想到，将要降临的是一场彻底的内战呢？<br><br>然而，不管人们想没想到，战争就这样发生了。部队在日耳曼尼亚倾注了全部注意力，确保首都处于军方的控制之下，不过在其他地方，追求着德意志祖国无上权柄的觊觎者们已经武装起来，战斗一触即发。施佩尔、海德里希、鲍曼、戈林，没有人知道谁会获得最终胜利，不过这个国家的所有民众都知道，他们未来的日子一片黑暗。<br><br>德国正在崩溃，城市街头陷入无政府状态，饕餮列强们争论着如何行动。英国和日本都在寻找从这场混乱中渔利的最佳时机，伊比利亚与意大利迅速开始军事化，趁着这混乱将自身的彩响力撒播出去。表面上对祖国忠心耿耿的专员辖区们也陷入了争吵，领导人们争论着该支持谁，或者是否是时候乘机开始将自己的领地与故乡拉开距离、划清界线。",
      buttonText: "血色将至。",
  ...
  },
  {
    ...
    data: {
      title: "德国内战",
      motto: "因此，所有人都必须认识到这一点：<br>与国家的存在相比，他的自我毫无意义。<br><br>- 阿道夫·希特勒",
      buttonText: "风云已起",
...
export const TNO_INITIAL_FOCUS_NODES: Node[] = [
  {
    ...
    type: "focus",
    position: { x: 200, y: 50 },
    data: { icon: "/tno/preset/GER_focus_GER_a_helping_hand.png", label: "伸出援手", status: "completed" },
  },
  {
    id: "focus-init-2",
    type: "focus",
    position: { x: 100, y: 200 },
    data: { icon: "/tno/preset/GER_focus_GER_aid_for_the_present.png", label: "支援现状", status: "inProgress" },
  },
  {
    id: "focus-init-3",
    type: "focus",
    position: { x: 300, y: 200 },
    data: { icon: "/tno/preset/GER_focus_GER_a_lighter_hand.png", label: "放宽控制", status: "unavailable" },
  },
];
